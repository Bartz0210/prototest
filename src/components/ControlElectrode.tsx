...
export function ControlElectrode({ label, checked5, checked4, checked3, checked2, checked1, checked0 }: Props) {
  return (
    <div className={theme.root}>
      ...
      <div style={{gridColumn: "1", gridRow:"2", background: "#dadada"}}></div>
      ...
      <div style={{gridColumn: "1", gridRow:"4", background: "#dadada"}}></div>
      <div style={{gridColumn: "3", gridRow:"4", background: "#dadada"}}></div>
      <div style={{gridColumn: "1", gridRow:"5"}}></div>
      <div style={{gridColumn: "3", gridRow:"5"}}></div>
      <div style={{gridColumn: "1", gridRow:"6", background: "#dadada"}}></div>
      <div style={{gridColumn: "3", gridRow:"6", background: "#dadada"}}></div>
      <div style={{gridColumn: "1", gridRow:"7"}}></div>
      <div style={{gridColumn: "3", gridRow:"7"}}></div>
      <div style={{gridColumn: "1", gridRow:"8", background: "#dadada"}}></div>
